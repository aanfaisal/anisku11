...
<!-- Title -->
<title>Anisku11.com | Aan Faisal Al Fallah Blog</title>
...
<link rel="stylesheet" href="{{ asset('css/color/blue-beige.css') }}" id="color" />
...
<div id="content" class="bg-white">
    ...
    <section id="start" class="section fullheight bg-secondary dark padding-v-60">
        ...
        <!-- BG Image -->
        <div class="bg-image animated infinite zooming"><img src="{{ asset('img/photos/it-bg01.jpg') }}" alt="..."></div>

        <!-- Middle -->
        <div class="container container-wide v-bottom padding-v-80">
            <img src="{{ asset('img/photos/it-avatar-96x96.') }}jpg" alt="..." class="img-circle margin-b-30">
            <h1 class="text-lg margin-b-0">Hi! I’m <strong>Johnatan Doe</strong></h1>
            ...
            <a href="#" class="btn btn-link"><span>Download my CV</span><i class="ti-file"></i></a>
        </div>
        ...
        <div class="container container-wide">
            ...
            <div id="portfolio-list" class="row masonry">
                ...
                <div class="webdesign masonry-item margin-b-30 col-lg-6 col-sm-12 col-xs-12">
                    <div class="gallery-item">
                        <div class="item-photo">
                            <a href="projects/project-example-it.html" data-target="ajax-modal"><img src="{{ asset('img/projects/project-square01.jpg') }}" alt="" /></a>
                ...
                <div class="development masonry-item margin-b-30 col-lg-3 col-sm-6 col-xs-12">
                    <div class="gallery-item">
                        <div class="item-photo">
                            <a href="projects/project-example-it.html" data-target="ajax-modal"><img src="{{ asset('img/projects/project-square02.jpg') }}" alt="" /></a>
                            <div class="item-hover bg-dark dark">
                                <div class="item-hover-content">
                                    <a href="projects/project-example-it.html" data-target="ajax-modal" class="icon icon-sm icon-hover icon-circle icon-primary"><i class="fa fa-link"></i></a>
                                    <a href="http://www.suelo.pl" target="_blank" class="icon icon-sm icon-circle icon-white icon-hover"><i class="fa fa-play"></i></a>
                ...
                <div class="graphic masonry-item margin-b-30 col-lg-3 col-sm-6 col-xs-12">
                    <div class="gallery-item">
                        <div class="item-photo">
                            <a href="projects/project-example-it.html" data-target="ajax-modal"><img src="{{ asset('img/projects/project-vertical01.jpg') }}" alt="" /></a>
                            <div class="item-hover bg-dark dark">
                                <div class="item-hover-content">
                                    <a href="projects/project-example-it.html" data-target="ajax-modal" class="icon icon-sm icon-hover icon-circle icon-primary"><i class="fa fa-link"></i></a>
                                    <a href="http://www.suelo.pl" target="_blank" class="icon icon-sm icon-circle icon-white icon-hover"><i class="fa fa-play"></i></a>
                ...
                <div class="webdesign masonry-item margin-b-30 col-lg-3 col-sm-6 col-xs-12">
                    <div class="gallery-item">
                        <div class="item-photo">
                            <a href="projects/project-example-it.html" data-target="ajax-modal"><img src="{{ asset('img/projects/project-vertical02.jpg') }}" alt="" /></a>
                            <div class="item-hover bg-dark dark">
                                <div class="item-hover-content">
                                    <a href="projects/project-example-it.html" data-target="ajax-modal" class="icon icon-sm icon-hover icon-circle icon-primary"><i class="fa fa-link"></i></a>
                                    <a href="http://www.suelo.pl" target="_blank" class="icon icon-sm icon-circle icon-white icon-hover"><i class="fa fa-play"></i></a>
                ...
                <div class="development masonry-item margin-b-30 col-lg-6 col-sm-12 col-xs-12">
                    <div class="gallery-item">
                        <div class="item-photo">
                            <a href="projects/project-example-it.html" data-target="ajax-modal"><img src="{{ asset('img/projects/project-horizontal01.jpg') }}" alt="" /></a>
                            <div class="item-hover bg-dark dark">
                                <div class="item-hover-content">
                                    <a href="projects/project-example-it.html" data-target="ajax-modal" class="icon icon-sm icon-hover icon-circle icon-primary"><i class="fa fa-link"></i></a>
                                    <a href="http://www.suelo.pl" target="_blank" class="icon icon-sm icon-circle icon-white icon-hover"><i class="fa fa-play"></i></a>
                ...
                <div class="graphic masonry-item margin-b-30 col-lg-3 col-sm-6 col-xs-12">
                    <div class="gallery-item">
                        <div class="item-photo">
                            <a href="projects/project-example-it.html" data-target="ajax-modal"><img src="{{ asset('img/projects/project-square03.jpg') }}" alt="" /></a>
                            <div class="item-hover bg-dark dark">
                                <div class="item-hover-content">
                                    <a href="projects/project-example-it.html" data-target="ajax-modal" class="icon icon-sm icon-hover icon-circle icon-primary"><i class="fa fa-link"></i></a>
                                    <a href="http://www.suelo.pl" target="_blank" class="icon icon-sm icon-circle icon-white icon-hover"><i class="fa fa-play"></i></a>
            ...
            <div class="row padding-lg">
                ...
                <div class="col-lg-4 col-sm-6">
                    ...
                    <div class="testimonial testimonial-dark">
                      ...
                      <div class="testimonial-author testimonial-with-photo">
                          <div class="testimonial-photo animated" data-animation="zoomIn"><img class="img-circle" src="{{ asset('img/photos/testimonial-avatar01.jpg') }}" alt="" /></div>
                    ...
                    <div class="testimonial testimonial-dark">
                      ...
                      <div class="testimonial-author testimonial-with-photo">
                          <div class="testimonial-photo animated" data-animation="zoomIn"><img class="img-circle" src="{{ asset('img/photos/testimonial-avatar02.jpg') }}" alt="" /></div>
                          <div class="testimonial-author-txt">
                              <span class="name">Mark Wagner</span>
                              <span class="caption text-secondary">Google Inc.</span>
                          </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    ...
                    <div class="testimonial testimonial-dark">
                      ...
                      <div class="testimonial-author testimonial-with-photo">
                          <div class="testimonial-photo animated" data-animation="zoomIn"><img class="img-circle" src="{{ asset('img/photos/testimonial-avatar03.jpg') }}" alt="" /></div>
                          <div class="testimonial-author-txt">
                              <span class="name">Mark Wagner</span>
                              <span class="caption text-secondary">Google Inc.</span>
                          </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    ...
                    <div class="testimonial testimonial-dark">
                      ...
                      <div class="testimonial-author testimonial-with-photo">
                          <div class="testimonial-photo animated" data-animation="zoomIn"><img class="img-circle" src="{{ asset('img/photos/testimonial-avatar04.jpg') }}" alt="" /></div>
                          <div class="testimonial-author-txt">
                              <span class="name">Mark Wagner</span>
                              <span class="caption text-secondary">Google Inc.</span>
                          </div>
            ...
            <div class="row masonry">
                ...
                <article class="post post-item masonry-item col-lg-4 col-sm-6 col-xs-12">
                    <div class="post-photo">
                        <img src="{{ asset('img/photos/post01.jpg') }}" alt="...">
                    </div>
                    <div class="post-content animated" data-animation="fadeInUp">
                        ...
                        <a href="blog-post-mobile.html" class="btn btn-primary btn-xs"><span>Read more</span><i class="ti-arrow-right"></i></a>
                    </div>
                </article>
                <!-- Masonry Element / Post -->
                <article class="post post-item masonry-item col-lg-4 col-sm-6 col-xs-12">
                ...
                <article class="post post-item masonry-item col-lg-4 col-sm-6 col-xs-12">
                    <div class="post-photo">
                        <img src="{{ asset('img/photos/post02.jpg') }}" alt="...">
                    </div>
                    <div class="post-content animated" data-animation="fadeInUp">
                        <div class="meta">
                            <span><i class="fa fa-comment"></i><a href="#">4</a></span>
                ...
                <article class="post post-item masonry-item col-lg-4 col-sm-6 col-xs-12">
                    <div class="post-photo">
                        <img src="{{ asset('img/photos/post03.jpg') }}" alt="...">
                    </div>
                    <div class="post-content animated" data-animation="fadeInUp">
                        <div class="meta">
                            <span><i class="fa fa-comment"></i><a href="#">4</a></span>
    ...
    <section id="contact" class="section padding-v-60 min-fullheight">
        ...
        <div class="contact-box bg-secondary dark animated" data-animation="flipInY">
            ...
            <ul class="list-inline">
                ...
                <li><a href="#" class="icon icon-circle icon-xs icon-google-plus"><i class="fa fa-twitter"></i></a></li>
            </ul>
...
<!-- Mobile Navigation -->
<a href="#" id="mobile-nav-toggle" class="icon icon-circle icon-sm icon-primary icon-hover" data-target="mobile-nav">
    <i class="ti-menu"></i>
</a>
